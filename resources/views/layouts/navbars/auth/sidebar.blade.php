  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      {{-- <li class="nav-item">
        <a class="nav-link {{ (Request::is('user-profile') ? 'active' : '') }} " href="{{ url('user-profile') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i class="fas fa-inbox ps-2 pe-2 text-center text-dark {{ (Request::is('user-management') ? 'text-white' : 'text-dark') }}" style="font-size: 1rem;" aria-hidden="true"></i>
            </div>
            <span class="nav-link-text ms-1">Surat Draft</span>
        </a>
    </li> --}}
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('persuratan/surat-draft') ? 'active' : '') }} " href="{{ url('persuratan/surat-draft') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i class="fas fa-inbox ps-2 pe-2 text-center text-dark {{ (Request::is('user-management') ? 'text-white' : 'text-dark') }}" style="font-size: 1rem;" aria-hidden="true"></i>
            </div>
            <span class="nav-link-text ms-1">Surat Draft</span>
    ...
    {{-- <li class="nav-item">
        <a class="nav-link {{ (Request::is('user-profile') ? 'active' : '') }} " href="{{ url('user-profile') }}">
            ...
            <span class="nav-link-text ms-1">Surat Diterima</span>
        </a>
    </li> --}}
    <li class="nav-item">
    ...
    {{-- <li class="nav-item">
        <a class="nav-link {{ (Request::is('user-profile') ? 'active' : '') }} " href="{{ url('user-profile') }}">
            ...
            <span class="nav-link-text ms-1">Surat Ditolak</span>
        </a>
    </li> --}}
    <li class="nav-item">
      ...
      {{-- <li class="nav-item pb-2">
        ...
        {{-- <li class="nav-item">
            <a class="nav-link {{ (Request::is('tables') ? 'active' : '') }}" href="{{ url('tables') }}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fas fa-user-friends ps-2 pe-2 text-center text-dark {{ (Request::is('user-management') ? 'text-white' : 'text-dark') }}" style="font-size: 1rem;" aria-hidden="true"></i>
                </div>
                <span class="nav-link-text ms-1">Jurusan</span>
            </a>
        </li> --}}
        <li class="nav-item">
            <a class="nav-link {{ (Request::is('master-data/jurusan') ? 'active' : '') }}" href="{{ url('master-data/jurusan') }}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fas fa-user-friends ps-2 pe-2 text-center text-dark {{ (Request::is('user-management') ? 'text-white' : 'text-dark') }}" style="font-size: 1rem;" aria-hidden="true"></i>
                </div>
                <span class="nav-link-text ms-1">Jurusan</span>
        ...
        {{-- <li class="nav-item">
            <a class="nav-link {{ (Request::is('tables') ? 'active' : '') }}" href="{{ url('tables') }}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fas fa-building ps-2 pe-2 text-center text-dark {{ (Request::is('user-management') ? 'text-white' : 'text-dark') }}" style="font-size: 1rem;" aria-hidden="true"></i>
          </div>
          <span class="nav-link-text ms-1">Perusahaan</span>
        </a>
      </li> --}}
        <li class="nav-item">
            <a class="nav-link {{ (Request::is('master-data/perusahaan') ? 'active' : '') }}" href="{{ url('master-data/perusahaan') }}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fas fa-building ps-2 pe-2 text-center text-dark {{ (Request::is('user-management') ? 'text-white' : 'text-dark') }}" style="font-size: 1rem;" aria-hidden="true"></i>
          </div>
          <span class="nav-link-text ms-1">Perusahaan</span>
