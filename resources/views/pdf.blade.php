    ...
    <div class="main">
        ...
        <table width="60%">
            <tr style="margin: 0;padding:0">
                ...
                <td style="margin: 0;padding:0" width="100%"><b>412.3/SMK-A1/700-1/623-CADISDIKWIL VIII</b></td>
            </tr>
            <tr style="margin: 0;padding:0">
       ...
       <div style="page-break-before: always">
        ...
        <table width="100%">
            <tr width="30%">
                ...
                <td width="5%">:</td>
                <td width="100%"><b>412.3/SMK-A1/700-1/623-CADISDIKWIL VIII</b></td>
            </tr>
            <tr>
        ...
        <table border="1" class="table-siswa" style="border-collapse:collapse">
            ...
            <tr>
                <td>1</td>
                <td style="text-align: left">ORDELIA RAMADHANI P</td>
                <td>232410208</td>
                <td rowspan="4" style="vertical-align: middle">Rekayasa Perangkat Lunak</td>
                <td rowspan="4" style="vertical-align: middle">04 Agustus 2025 sampai dengan 29 November 2025</td>
            </tr>
            <tr>
                <td>2</td>
                <td style="text-align: left">DESTIA ANGGRAENI</td>
                <td>232410193</td>
            </tr>
            <tr>
                <td>3</td>
                <td style="text-align: left">MUGIANY TRIE ASTARI</td>
                <td>232410202</td>
            </tr>
            <tr>
                <td>4</td>
                <td style="text-align: left">SILFA GIANITA</td>
                <td>232410186</td>
            </tr>
        </table>
       ...
       <div style="page-break-before: always">
        ...
        <p class="text-justy">Berdasarkan surat permohonan PKL Nomor : 412.3/SMK-A1/700-1/623-CADISDIKWIL VIII Maka dengan ini kami <b> Bersedia / Tidak Bersedia </b> untuk menerima Siswa :</p>
        <table border="1" class="table-siswa" style="border-collapse:collapse">
            <tr>
                <th style="border: 1px solid black">No.</th>
                <th style="border: 1px solid black">Nama</th>
        ...
        <p class="mt-5 text-justy">Untuk melaksanakan PKL (Praktik Kerja Lapangan) di <b>PT Aegislabs</b> mulai tanggal <b>04 Agustus 2025 sampai dengan 29 November 2025</b></p>
