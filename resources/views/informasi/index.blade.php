            ...
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        <a href="{{ url('master-data/informasi/add') }}" class="btn bg-gradient-info btn-sm mb-0" type="button">+&nbsp; Tambah Informasi</a>
                    </div>
                </div>
                                    ...
                                    @foreach ($informasi as $data )
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="{{ url('master-data/informasi/edit/'.$data->id ) }}" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Detail data">
...
<script>
    function updateOrderStatus(index,orderId,props) {
        ...
        $.ajax({
            url: `/master-data/informasi/status/${orderId}`,
            type: 'PUT',
            data: {
                _token: '{{ csrf_token() }}',
                status: status
